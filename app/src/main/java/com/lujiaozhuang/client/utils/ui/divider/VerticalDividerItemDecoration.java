package com.lujiaozhuang.client.utils.ui.divider;
...
import com.lujiaozhuang.client.widget.autoloadding.RecyclerViewWithHeaderAndFooter;
...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    protected void setItemOffsets(Rect outRect, int position, int childCount, RecyclerView parent) {
        ...
        if (isLastColum(parent, position - headSize, getSpanCount(parent), childCount-headSize))// 如果是最后一列，则不需要绘制右边
        {
            outRect.set(0, 0, 0, 0);
            return;
        }
