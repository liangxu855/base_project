package com.lujiaozhuang.client.utils.ui;
...
public class AndroidBug5497Workaround {
    ...
    public static AndroidBug5497Workaround assistActivity(BaseActivity activity) {
    ...
    private AndroidBug5497Workaround(final BaseActivity activity) {
    ...
    private void possiblyResizeChildOfContent(final BaseActivity activity) {
        ...
        if (usableHeightNow != usableHeightPrevious) {
            ...
            if (heightDifference > (usableHeightSansKeyboard / 4)) {
                ...
                frameLayoutParams.height = usableHeightSansKeyboard - heightDifference + (UiUtils.getStatusHeight() - activity.getStatusBarPaddingTop());
            } else {
                // keyboard probably just became hidden
                frameLayoutParams.height = usableHeightSansKeyboard - activity.getStatusBarPaddingTop();
            }
