...
public class LoadingAndRetryLayout extends FrameLayout {
    ...
    public View setContentView(int layoutId) {
        ...
        return setContentView(UiUtils.getInflaterView(getContext(), layoutId, this, false));
    }

    public View setLoadingView(int layoutId) {
        return setLoadingView(UiUtils.getInflaterView(getContext(), layoutId, this, false));
    }

    public View setEmptyView(int layoutId) {
        return setEmptyView(UiUtils.getInflaterView(getContext(), layoutId, this, false));
    }

    public View setRetryView(int layoutId) {
        return setRetryView(UiUtils.getInflaterView(getContext(), layoutId, this, false));
    }
