package com.lujiaozhuang.client.widget.swipemenulistview;
...
import com.lujiaozhuang.client.widget.autoloadding.ListViewForAutoLoad;
 ...
 * @date 2014-8-18
 */
public class SwipeMenuListView extends ListViewForAutoLoad {
    ...
    public void setAdapter(ListAdapter adapter) {
        swipeMenuAdapter = new SwipeMenuAdapter(getContext(), (BaseAdapter) adapter) {
            @Override
    ...
    public void setOnMenuItemClickListener(
        ...
        swipeMenuAdapter.setOnSwipeItemClickListener(onMenuItemClickListener);
    }
    ...
    public static interface OnMenuItemClickListener {
        boolean onMenuItemClick(int position, SwipeMenuLayout layout, SwipeMenu menu, int index);
    }
